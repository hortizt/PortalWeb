...
def peticiones = DbUtilMQM.sql.rows('SELECT * FROM PS_PETICION')
                ...
                <div class="span6">
                    <table class="table table-striped">
                        ...
                        <tbody>
                          <%      peticiones.each { pet -> %>
                                <tr class="datorad">
                                    <td class="dato">${pet["PT_IDPETICION"]}</td>
                                    <td>${pet["PT_IDSERVICIO"]}</td>
                                    <td>${pet["PT_MENSAJEERROR"]}</td>
                                </tr>
                            <% } %>
                        </tbody>
                    </table>
...
out << template.make(peticiones: peticiones)
